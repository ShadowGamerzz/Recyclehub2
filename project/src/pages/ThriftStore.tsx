...
export default function ThriftStore() {
  ...
  const thriftItems = getProductsByListingType('thrift')
    .filter(product => 
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          {thriftItems.length} items available
        </p>
      </div>
      ...
      {thriftItems.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">No thrift items found</h3>
